...
void PlaneTest::testIntersection(){
	...
	Geometry::Vec3 s;
	CPPUNIT_ASSERT (p1.getIntersection(Geometry::Segment3(Geometry::Vec3(18,0,20),Geometry::Vec3(18,17,20) ),s)==true) ;
	CPPUNIT_ASSERT (s==Geometry::Vec3(18,17,20)) ;

	// segment too short; no intersection
	CPPUNIT_ASSERT (p1.getIntersection(Geometry::Segment3(Geometry::Vec3(18,0,20),Geometry::Vec3(18,16,20) ),s)==false) ;
	...
	// intersection with segment
	CPPUNIT_ASSERT(p2.getIntersection(Geometry::Segment3(Geometry::Vec3(3,2,20),Geometry::Vec3(1,6,20) ),s)==true) ;
...
void PlaneTest::testMisc(){
	...
	CPPUNIT_ASSERT_DOUBLES_EQUAL( p2.planeTest(Geometry::Vec3(2,1,17)),
								  Geometry::Vec3(Geometry::Vec3(2,1,17)).planeTest(p2.getNormal(),p2.getOffset()), 0.001);
