...
void SphereTest::testMisc() {
	...
	
	{
		...
		CPPUNIT_ASSERT_EQUAL(Sphere_d(Vec3d(2, 0, 0), 6), Sphere_d(Vec3d(0, 0, 0), 4).include(Sphere_d(Vec3d(4, 0, 0), 4)));
		CPPUNIT_ASSERT_EQUAL(Sphere_d(Vec3d(4, 0, 0), 8), Sphere_d(Vec3d(0, 0, 0), 4).include(Sphere_d(Vec3d(8, 0, 0), 4)));
		CPPUNIT_ASSERT_EQUAL(Sphere_d(Vec3d(5, 0, 0), 10), Sphere_d(Vec3d(0, 0, 0), 5).include(Sphere_d(Vec3d(10, 0, 0), 5)));
		
		assertSpheresEqual(Sphere_d(Vec3d(9, 0, 0), 10), Sphere_d(Vec3d(0, 0, 0), 1).include(Sphere_d(Vec3d(10, 0, 0), 9)), 1.0e-6);
		assertSpheresEqual(Sphere_d(Vec3d(8, 0, 0), 10), Sphere_d(Vec3d(0, 0, 0), 2).include(Sphere_d(Vec3d(10, 0, 0), 8)), 1.0e-6);
		assertSpheresEqual(Sphere_d(Vec3d(7, 0, 0), 10), Sphere_d(Vec3d(0, 0, 0), 3).include(Sphere_d(Vec3d(10, 0, 0), 7)), 1.0e-6);
		assertSpheresEqual(Sphere_d(Vec3d(6, 0, 0), 10), Sphere_d(Vec3d(0, 0, 0), 4).include(Sphere_d(Vec3d(10, 0, 0), 6)), 1.0e-6);
		assertSpheresEqual(Sphere_d(Vec3d(5, 0, 0), 10), Sphere_d(Vec3d(0, 0, 0), 5).include(Sphere_d(Vec3d(10, 0, 0), 5)), 1.0e-6);
		assertSpheresEqual(Sphere_d(Vec3d(4, 0, 0), 10), Sphere_d(Vec3d(0, 0, 0), 6).include(Sphere_d(Vec3d(10, 0, 0), 4)), 1.0e-6);
		assertSpheresEqual(Sphere_d(Vec3d(3, 0, 0), 10), Sphere_d(Vec3d(0, 0, 0), 7).include(Sphere_d(Vec3d(10, 0, 0), 3)), 1.0e-6);
		assertSpheresEqual(Sphere_d(Vec3d(2, 0, 0), 10), Sphere_d(Vec3d(0, 0, 0), 8).include(Sphere_d(Vec3d(10, 0, 0), 2)), 1.0e-6);
		assertSpheresEqual(Sphere_d(Vec3d(1, 0, 0), 10), Sphere_d(Vec3d(0, 0, 0), 9).include(Sphere_d(Vec3d(10, 0, 0), 1)), 1.0e-6);
	}
}
...
void SphereTest::testCoordinates() {
	...
	CPPUNIT_ASSERT(Vec3d(0.0, 1.0, 0.0).distanceSquared(Sphere_d::calcCartesianCoordinateUnitSphere(0.0, M_PI_2)) < dist);
	CPPUNIT_ASSERT(Vec3d(0.0, 1.0, 0.0).distanceSquared(Sphere_d::calcCartesianCoordinateUnitSphere(0.0, M_PI)) < dist);
	CPPUNIT_ASSERT(Vec3d(0.0, 1.0, 0.0).distanceSquared(Sphere_d::calcCartesianCoordinateUnitSphere(0.0, 3.0 * M_PI_2)) < dist);
	
	CPPUNIT_ASSERT(Vec3d(0.0, -1.0, 0.0).distanceSquared(Sphere_d::calcCartesianCoordinateUnitSphere(M_PI, 0.0)) < dist);
	CPPUNIT_ASSERT(Vec3d(0.0, -1.0, 0.0).distanceSquared(Sphere_d::calcCartesianCoordinateUnitSphere(M_PI, M_PI_2)) < dist);
	CPPUNIT_ASSERT(Vec3d(0.0, -1.0, 0.0).distanceSquared(Sphere_d::calcCartesianCoordinateUnitSphere(M_PI, M_PI)) < dist);
	CPPUNIT_ASSERT(Vec3d(0.0, -1.0, 0.0).distanceSquared(Sphere_d::calcCartesianCoordinateUnitSphere(M_PI, 3.0 * M_PI_2)) < dist);
	
	CPPUNIT_ASSERT(Vec3d(1.0, 0.0, 0.0).distanceSquared(Sphere_d::calcCartesianCoordinateUnitSphere(M_PI_2, 0.0)) < dist);
	CPPUNIT_ASSERT(Vec3d(0.0, 0.0, 1.0).distanceSquared(Sphere_d::calcCartesianCoordinateUnitSphere(M_PI_2, M_PI_2)) < dist);
	CPPUNIT_ASSERT(Vec3d(-1.0, 0.0, 0.0).distanceSquared(Sphere_d::calcCartesianCoordinateUnitSphere(M_PI_2, M_PI)) < dist);
	CPPUNIT_ASSERT(Vec3d(0.0, 0.0, -1.0).distanceSquared(Sphere_d::calcCartesianCoordinateUnitSphere(M_PI_2, 3.0 * M_PI_2)) < dist);
	
	{
		...
		CPPUNIT_ASSERT(Vec3d(5.0, 5.0, 3.0).distanceSquared(sphere.calcCartesianCoordinate(M_PI_2, 3.0 * M_PI_2)) < dist);
	}
}
