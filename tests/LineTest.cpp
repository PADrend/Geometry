...
void LineTest::testGetters() {
	...
	CPPUNIT_ASSERT_EQUAL(Geometry::Vec3f(1000.0f, 0.0f, 0.0f), lineX.getClosestPoint(Geometry::Vec3f(1000.0f, 0.0f, 0.0f)));
	CPPUNIT_ASSERT_EQUAL(Geometry::Vec3f(-1000.0f, 0.0f, 0.0f), lineX.getClosestPoint(Geometry::Vec3f(-1000.0f, 0.0f, 0.0f)));

	CPPUNIT_ASSERT_EQUAL(Geometry::Vec3f(0.0f, 0.0f, 0.0f), lineY.getClosestPoint(Geometry::Vec3f(0.0f, 0.0f, 0.0f)));
	CPPUNIT_ASSERT_EQUAL(Geometry::Vec3f(0.0f, 1000.0f, 0.0f), lineY.getClosestPoint(Geometry::Vec3f(0.0f, 1000.0f, 0.0f)));
	CPPUNIT_ASSERT_EQUAL(Geometry::Vec3f(0.0f, -1000.0f, 0.0f), lineY.getClosestPoint(Geometry::Vec3f(0.0f, -1000.0f, 0.0f)));
