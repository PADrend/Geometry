...
class _Vec2 {
	...
	public:
		...
		inline const value_t getX() const        {   return x(); }
		inline const value_t getY() const        {   return y(); }
		inline const value_t getWidth() const    {   return x(); }
		inline const value_t getHeight() const   {   return y(); }
		inline const value_t width() const       {   return x(); }
		inline const value_t height() const      {   return y(); }
		...
		inline void x(const value_t a)           {   vec[0]=a;   }
		inline void y(const value_t a)           {   vec[1]=a;   }
		inline void setX(const value_t a)        {   x(a);   }
		inline void setY(const value_t a)        {   y(a);   }
		inline void setWidth(const value_t a)    {   x(a);   }
		inline void setHeight(const value_t a)   {   y(a);   }
		inline void width(const value_t a)       {   x(a);   }
		inline void height(const value_t a)      {   y(a);   }
