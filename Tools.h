...
inline bool rayPlaneIntersection(const Vec3f & planePos,const Vec3f & planeNormal,const Vec3f & rayPos, const Vec3f & rayDir,Vec3f & intersectionPoint) {
...
void getClosestPoints(const _Line<_Vec3<float_t> > & lineA, const _Line<_Vec3<float_t> > & lineB, float_t & parameterA, float_t & parameterB) {
 ...
 */
template<typename float_t>
void getClosestPoints(const _Line<_Vec3<float_t> > & line, const _Ray<_Vec3<float_t> > & ray, float_t & parameterA, float_t & parameterB) {
 ...
 */
template<typename float_t>
inline _Vec3<float_t> getClosestPointOnLineToRay(const _Vec3<float_t> & linePos, const _Vec3<float_t> & lineDir, const _Vec3<float_t> & rayPos, const _Vec3<float_t> & rayDir) {
...
inline _Vec3<_T> project(const _Vec3<_T> & obj,
						 const _Matrix4x4<_T> & worldToScreen, 
						 const _Rect<_T> & viewport) {
 ...
 */
template<typename _T>
inline _Vec3<_T> unProject(const _Vec3<_T> & win,
						   const _Matrix4x4<_T> & worldToScreen,
						   const _Rect<_T> & viewport) {
	const _T one = static_cast<_T>(1.0);
	const _T two = static_cast<_T>(2.0);
