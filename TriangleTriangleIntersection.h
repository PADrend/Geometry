...
inline void _intersect(
		const _Vec3<value_t> & v0, const _Vec3<value_t> & v1, const _Vec3<value_t> & v2,
		value_t pv0, value_t pv1, value_t pv2,
		float dv0, float dv1, float dv2,
		float* intersection1, float* intersection2,
		_Vec3<value_t> & point1, _Vec3<value_t> & point2
		) {
...
template<typename value_t>
inline bool _computeIntersectionInterval(const Triangle<_Vec3<value_t>> & triangle,
