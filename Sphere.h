...
class _Sphere {
	...
	//@{
		 ...
		 * The function @a calcCartesianCoordinateUnitSphere is called, and center and radius of this sphere are applied to the result.
		 *
		...
		static vec3_t calcCartesianCoordinateUnitSphere(value_t inclination, value_t azimuth) {
			...
			return _Vec3<value_t>(
				sinInclination * std::cos(azimuth),
				std::cos(inclination),
